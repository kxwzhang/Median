...
# Comments
comment1 = Comment.create!(comment: Faker::Quote.famous_last_words, commenter_id: user1.id, story_id: story2.id, parent_comment_id: nil)
comment2 = Comment.create!(comment: Faker::Quote.famous_last_words, commenter_id: user2.id, story_id: story1.id, parent_comment_id: nil)
comment3 = Comment.create!(comment: Faker::Quote.famous_last_words, commenter_id: user3.id, story_id: story1.id, parent_comment_id: comment2.id)
comment4 = Comment.create!(comment: Faker::Quote.famous_last_words, commenter_id: user4.id, story_id: story3.id, parent_comment_id: nil)
comment5 = Comment.create!(comment: Faker::Quote.famous_last_words, commenter_id: user5.id, story_id: story4.id, parent_comment_id: nil)
comment6 = Comment.create!(comment: Faker::Quote.famous_last_words, commenter_id: user1.id, story_id: story5.id, parent_comment_id: nil)
comment7 = Comment.create!(comment: Faker::Quote.famous_last_words, commenter_id: user2.id, story_id: story6.id, parent_comment_id: nil)
comment8 = Comment.create!(comment: Faker::Quote.famous_last_words, commenter_id: user3.id, story_id: story7.id, parent_comment_id: nil)
comment9 = Comment.create!(comment: Faker::Quote.famous_last_words, commenter_id: user4.id, story_id: story8.id, parent_comment_id: nil)
comment10 = Comment.create!(comment: Faker::Quote.famous_last_words, commenter_id: user5.id, story_id: story9.id, parent_comment_id: nil)
comment11 = Comment.create!(comment: Faker::Quote.famous_last_words, commenter_id: user6.id, story_id: story10.id, parent_comment_id: nil)
comment12 = Comment.create!(comment: Faker::Quote.famous_last_words, commenter_id: user7.id, story_id: story11.id, parent_comment_id: nil)
comment13 = Comment.create!(comment: Faker::Quote.famous_last_words, commenter_id: user8.id, story_id: story12.id, parent_comment_id: nil)
comment14 = Comment.create!(comment: Faker::Quote.famous_last_words, commenter_id: user8.id, story_id: story13.id, parent_comment_id: nil)
comment15 = Comment.create!(comment: Faker::Quote.famous_last_words, commenter_id: user1.id, story_id: story14.id, parent_comment_id: nil)
comment16 = Comment.create!(comment: Faker::Quote.famous_last_words, commenter_id: user2.id, story_id: story15.id, parent_comment_id: nil)
comment17 = Comment.create!(comment: Faker::Quote.famous_last_words, commenter_id: user3.id, story_id: story16.id, parent_comment_id: nil)
comment18 = Comment.create!(comment: Faker::Quote.famous_last_words, commenter_id: user4.id, story_id: story16.id, parent_comment_id: comment17.id)
comment19 = Comment.create!(comment: Faker::Quote.famous_last_words, commenter_id: user5.id, story_id: story16.id, parent_comment_id: nil)
comment20 = Comment.create!(comment: Faker::Quote.famous_last_words, commenter_id: user6.id, story_id: story16.id, parent_comment_id: comment19.id)
